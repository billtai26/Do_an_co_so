...
export const EMAIL_RULE_MESSAGE = 'Email is invalid. (example@anhtaipxuan.com)'
...
export const ALLOW_COMMON_FILE_TYPES = ['image/jpg', 'image/jpeg', 'image/png', 'application/pdf']
export const singleFileValidator = (file) => {
  ...
  if (!ALLOW_COMMON_FILE_TYPES.includes(file.type)) {
    return 'File type is invalid. Only accept jpg, jpeg, png and pdf'
  }
  return null
}
