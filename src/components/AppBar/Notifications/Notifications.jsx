...
function Notifications() {
  ...
  const handleClickNotificationIcon = (event) => {
    ...
    // Khi click vào phần thông báo thì set lại trạng thái của biến newNotification về false
  ...
  // Lấy dữ liệu notifications từ trong trong Redux
  ...
  useEffect(() => {
    ...
    const onReceiveNewInvitation = (invitation) => {
      ...
      if (invitation.inviteeId === currentUser._id) {
        // Bước 01: Thêm bản ghi invitation mới vào trong redux
        dispatch(addNotification(invitation))
        // Bước 02: Cập nhật trạng thái đang có thông báo đến
