...
export const activeBoardSlice = createSlice({
  ...
  reducers: {
    ...
    updateCurrentActiveBoard: (state, action) => {
      ...
      // Update lại dữ liệu của cái cái currentActiveBoard
    ...
    updateCardInBoard: (state, action) => {
      ...
      if (column) {
        ...
        if (card) {
           ...
           * Sau đó tuỳ vào trường hợp cần thì kiểm tra thêm còn không thì cập nhật ngược lại giá trị vào card luôn như bên dưới.
           */
...
// Để ý ở trên thì không thấy properties actions đâu cả, bởi vì những cái action này đơn giản là được thằng redux tạo tự động theo tên của reducer nhé.
export const { updateCurrentActiveBoard, updateCardInBoard } = activeBoardSlice.actions

// Selectors: Là nơi dành cho các components bên dưới gọi bằng hook useSeletor() để lấy dữ liệu từ trong kho redux store ra sử dụng
